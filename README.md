...
[![version](https://img.shields.io/badge/version-v2.8.2-4D6BFE)](#version-history)
...
1. **Download** [`public/downloads/dsh-local-v2.8.2.apk`](public/downloads/dsh-local-v2.8.2.apk)
...
│   ├── AndroidManifest.xml           # com.dshlocal.app, targetSdk 28, v2.8.2
