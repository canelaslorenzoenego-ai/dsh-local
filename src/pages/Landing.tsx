...
const APK_FILE =
  "https://github.com/canelaslorenzoenego-ai/dsh-local/releases/latest/download/dsh-local-v2.8.3.apk";
const APK_FALLBACK =
  "https://raw.githubusercontent.com/canelaslorenzoenego-ai/dsh-local/main/public/downloads/dsh-local-v2.8.3.apk";
void APK_FALLBACK;
